...
import {getInitials, useUpdateEffect} from "../utils";
...
const Home = ({navigation})=>{
  ...
  useUpdateEffect(() => {
    ...
    <View style={{width: width, minHeight: height *.5}}>
    ...
    <View style={[styles.hero]}>
        ...
        <Image resizeMode= "contain" style={{width: width* .32, height: width* .32, borderRadius: 16}} source={require('../assets/Hero_image.png')} />
    </View>
    <Searchbar
        ...
        iconColor="#495E57"
        inputStyle={{ color: '#333333', fontSize: 15,
